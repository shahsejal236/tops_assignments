            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="{{url('frontend/img/service-1.jpg')}}" alt="">
                    </div>
                ...
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.3s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="{{url('frontend/img/service-2.jpg')}}" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                ...
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.5s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="{{url('frontend/img/service-3.jpg')}}" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 pt-4" style="min-height: 500px;">
                    <div class="position-relative h-100 wow fadeInUp" data-wow-delay="0.5s">
                        <img class="position-absolute img-fluid w-100 h-100" src="{{url('frontend/img/about-1.jpg')}}" style="object-fit: cover; padding: 0 0 50px 100px;" alt="">
                        <img class="position-absolute start-0 bottom-0 img-fluid bg-white pt-2 pe-2 w-50 h-50" src="{{url('frontend/img/about-2.jpg')}}" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="{{url('frontend/img/testimonial-1.jpg')}}" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                ...
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="{{url('frontend/img/testimonial-2.jpg')}}" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                ...
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="{{url('frontend/img/testimonial-3.jpg')}}" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                ...
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="{{url('frontend/img/testimonial-4.jpg')}}" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
