            ...
            <div class="row g-4">
                ...
                @if(session('success'))
                    ...
                    <div class="bg-light p-5 h-100 d-flex align-items-center">
                        <form>
                        <form action="{{url('/insertsignup')}}" method="post" ">
							@csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                        ...
                                        <div class="form-floating">
                                        <input type="textarea" class="form-control" id="phoneno" placeholder="phone no">
                                        <label for="name">Phone No </label>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="age" placeholder="Your Name">
                                ...
                                <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="file" name="file" class="form-control" id="file" placeholder="Your file">
