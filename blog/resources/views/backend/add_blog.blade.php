      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Add Blogs</h2>
              </div>
            </div>
            <div class="row tm-edit-product-row">
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="form-group mb-3">
                    <label
                      for="name"
                      >Content
                    </label><textarea class="form-control validate" 
              ...
              <div class="col-12">
                <button type="submit" name="submit" class="btn btn-primary btn-block text-uppercase">Add Blog </button>
              </div>
            </form>
            </div>
          </div>
