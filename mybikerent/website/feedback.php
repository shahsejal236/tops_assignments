...
<html lang="en">
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Feedback Us</h1>
            <div class="row">
                    ...
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="" id="form1" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <textarea class="form-control py-3 px-4" rows="5" name="f_desc" placeholder="Message" data-bvalidator="required,alpha"></textarea>
                            </div>
                            <div>
