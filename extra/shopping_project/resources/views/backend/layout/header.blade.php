<head>
    ...
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="{{url('backend/assets/css/main.css')}}">
    <!-- Font-icon css-->
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
      <li><a class="app-menu__item" href="index"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">User Site</span></a></li>
        <li><a class="app-menu__item" href="adminindex"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
       
    
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Manage User</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            
            <li><a class="treeview-item active" href="adduser"><i class="icon fa fa-circle-o"></i> Add Users</a></li>
            
            <li><a class="treeview-item active" href="addseller"><i class="icon fa fa-circle-o"></i> Add sellers</a></li>
    ...
    <script src="{{url('backend/assets/js/plugins/pace.min.js')}}"></script>
    <!-- Page specific javascripts-->
    <script type="text/javascript" src="{{url('backend/assets/js/plugins/chart.js')}}"></script>
