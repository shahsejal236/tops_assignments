                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="full dis_flex center_text">
                                          <div class="profile_img"><img width="180" class="rounded-circle" src="{{url('backend/assets/images/layout_img/user_img.jpg')}}" alt="#" /></div>
                                                ...
                                                <div class="tab-content" id="nav-tabContent">
                                                   <div class="tab-pane fade show active" id="recent_activity" role="tabpanel" aria-labelledby="nav-home-tab">
                                                      <div class="msg_list_main">
                                                         <ul class="msg_list">
                                                            <li>
                                                               <span><img src="{{url('backend/assets/images/layout_img/msg2.png')}}" class="img-responsive" alt="#"></span>
                                                               <span>
                                                            ...
                                                            <li>
                                                               <span><img src="{{url('backend/assets/images/layout_img/msg3.png')}}" class="img-responsive" alt="#"></span>
                                                               <span>
